export class Character {
     PlayGround(selector_ch1)
{
     var jquery:any;
     var $ :any;
	//create the first character
	var ch1 = new this.Character(selector_ch1);
 ...
 Character(selector)
{
	...
	var action = "STANDING";	//default action is for the character to stand
	var prev_action = action;	//store the previous action of the character
	var ch_x=0;					//x_coordinate of the character
	var ch_y=0;					//y_coordinate of the character
